    ...
    private function setSteps() {
	    ...
	    $this->steps =
          ...
          array ( "HostEditor" => array(
                    ...
                    "hostEditorAdditionURI" => "pharoah-tools.dev-jenkins.tld",
          ) , ) ,
          array ( "VHostEditor" => array(
                    "virtualHostEditorAdditionExecute" => true,
                    "virtualHostEditorAdditionDocRoot" => "",
                    "virtualHostEditorAdditionURL" => "pharoah-tools.dev-jenkins.tld",
          ...
          array ( "DBConfigure" => array(
                    ...
                    "dbConfigureDBUser" => "ptls_ts_user",
                    "dbConfigureDBPass" => "ptls_ts_pass",
                    "dbConfigureDBName" => "ptls_ts_name",
          ...
          array ( "DBInstall" => array(
                    ...
                    "dbInstallDBUser" => "ptls_ts_user",
                    "dbInstallDBPass" => "ptls_ts_pass",
                    "dbInstallDBName" => "ptls_ts_name",
