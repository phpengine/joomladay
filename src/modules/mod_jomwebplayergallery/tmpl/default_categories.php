...
/*
 * @version		$Id: default_categories.php 3.1.0 2012-10-28 $
 * @package		Joomla
...
<div class="jomwebplayer_gallery">
  <?php 
  	for ($i=0, $n=count($categories); $i < $n; $i++) {   
		...
		echo $clear;
  	?>
  <div class="jomwebplayer_thumb" style="width:<?php echo $thumb_width; ?>px;" onclick='javascript:location.href="<?php echo JRoute::_($link.$qs.$categories[$i]->id); ?>"'>
