    ...
    <tbody>
      <?php
		...
		for ($i=0, $n=count($data); $i < $n; $i++) {
			...
			$vid  	   = JRoute::_( 'index.php?option=com_jomwebplayer&wid='.$row->id );
			$delete    = JRoute::_( 'index.php?option=com_jomwebplayer&view=delete&uid='.$row->id );
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td align="center">
        	<a href="<?php echo $link; ?>">
            	<img src="<?php echo JURI::root().'components/com_jomwebplayer/assets/edit.jpg'; ?>" border="0" />
            </a>
        </td>
        <td align="center">
        	<a href="<?php echo $delete; ?>">
            	<img src="<?php echo JURI::root().'components/com_jomwebplayer/assets/delete.jpg'; ?>"  border="0" />
            </a>
        </td>
