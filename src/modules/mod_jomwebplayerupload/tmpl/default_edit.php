...
/*
 * @version		$Id: default_edit.php 3.1.0 2012-10-28 $
 * @package		Joomla
...
<form action="index.php?option=com_jomwebplayer&view=edit" method="post" name="adminForm" id="adminForm" onsubmit="return submitbutton();" enctype="multipart/form-data">
  <div id="tbl">
