...
/*
 * @version		$Id: default_add.php 3.1.0 2012-10-28 $
 * @package		Joomla
...
$target = preg_replace('/(?:&|(\?))add=[^&]*(?(1)&|)?/i', "$1", $target);
...
<form action="index.php?option=com_jomwebplayer&view=add" method="post" name="adminForm" id="adminForm" onsubmit="return submitbutton();" enctype="multipart/form-data">
  <div id="tbl">
    <table cellpadding="0px" cellspacing="0px" border="0">
      ...
      <tr>
        ...
        <td><select id="type" name="type" onchange="javascript:changeType(this.options[this.selectedIndex].id);">
          ...
          &nbsp;&nbsp;<a href="javascript:switchHelp();">what is this?</a> </td>
      </tr>
      ...
      <tr>
        <td>Category</td>
        <td><?php echo JHTML::_('select.genericlist', $category_options, 'category', '', 'value', 'text', ''); ?></td>
      </tr>
      <tr>
        <td></td>
        <td>
