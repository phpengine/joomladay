...
/*
 * @version		$Id: script.jomwebplayer.php 3.1.0 2012-10-28 $
 * @package		Joomla
...
class Com_JomWebplayerInstallerScript {
...
(1, '', 0, 0, 0);";
	...
	public function update($type) {
	 	$db = JFactory::getDBO();				
		$fields_settings = $db->getTableColumns('#__jomwebplayer_settings');
		$fields_videos   = $db->getTableColumns('#__jomwebplayer_videos');
		$fields_category = $db->getTableColumns('#__jomwebplayer_category');
