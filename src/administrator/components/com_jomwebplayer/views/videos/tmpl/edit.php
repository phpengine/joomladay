...
/*
 * @version		$Id: edit.php 3.1.0 2012-10-28 $
 * @package		Joomla
...
<div id="jomwebplayer">
  <form action="index.php?option=com_jomwebplayer&view=videos" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <div style="float:left;width:52%">
      ...
      <table class="admintable">
        ...
        <tr>
          ...
          <td><input type="checkbox" name="featured" value="1" <?php if($data->featured==1){echo 'checked="checked" ';}?> /></td>
        </tr>
        <tr>
      ...
      <table class="admintable">
        <tr>
          <td><?php echo $editor->display( 'description', $data->description , '625', '300', '', '', true ); ?></td>
        </tr>
      </table>
      </fieldset>
    </div>
...
function checkExtension(type, filePath, validExtensions, method) {
    if(method == 'Youtube Videos' || method == 'Dailymotion Videos' || method == 'RTMP Streams') return true;
...
function changeType(typ) {
 ...
 function uploadMode(typ) {
    ...
    mode = '<input type="file" name="upload' + typ + '" accept="' + formats + '" maxlength="100" />';
	document.getElementById('upload_' + typ).innerHTML = mode;	
}	
</script>