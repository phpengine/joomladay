...
<div id="jomwebplayer">
  <form action="index.php?option=com_jomwebplayer&view=category" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <table style="padding-bottom:10px;">
      <tr>
        ...
        <td nowrap="nowrap">
			<?php echo $this->lists['categories']; ?> <?php echo $this->lists['state']; ?> <?php if(JOMWEBPLAYER_JVERSION == '3.0') echo $this->pagination->getLimitBox(); ?>
        </td>
      </tr>
    </table>
    <table class="adminlist table table-striped">
      ...
      <tbody>
		...
		for ($i=0, $n=count($data); $i < $n; $i++) {
			...
			$k         = $i % 2;
			$link 	   = JRoute::_( 'index.php?option=com_jomwebplayer&view=category&task=edit&'. JomWebplayerUtility::getToken() .'=1&'.'cid[]='. $row->id );
